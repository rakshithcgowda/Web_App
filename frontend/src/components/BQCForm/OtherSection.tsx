  ...
  return (
    <div className="space-y-8">
      ...
      <div className="card">
        ...
        {/* Additional Details Explanatory Note Section */}
        <div className="form-group">
          <label className="form-label text-lg mb-4 block">
            Additional Details
          </label>
          <ExplanatoryNote
            ...
            placeholder="The additional requirement has been taken as 30% of diameter of proposed External Floating Roof tank mentioned in PR (i.e., 30% of 40 meter diameter)."
          />
        </div>
        ...
        <div>
          <div className="flex items-center space-x-3 mb-3">
            <label className="flex items-center space-x-2 cursor-pointer">
              <input
                type="checkbox"
                checked={data.hasEMDPreview || false}
                onChange={(e) => onChange({ hasEMDPreview: e.target.checked })}
                className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
              />
              <span className="text-sm font-medium text-gray-900">
                EMD Preview (any variance from ITB)
              </span>
            </label>
          </div>
